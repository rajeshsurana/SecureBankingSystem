	...
	<div class="container">
		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<sf:form cssClass="form-horizontal" action="${pageContext.request.contextPath}/CommitNewManager.do" method="post" commandName="bankUser">
				...
				<div class="form-group">
					...
					<sf:input type="text" cssClass="form-control" placeholder="Enter Your Date Of Birth in mm/dd/yyyy" id="dob_manager"
				...
				<div class="form-group">
					...
					title="WARNING: Resets information Entered" 
					 />
				</div>
				</sf:form>
			</div>
