...
<title>Manager - Authorize External User Account Changes</title>
<script>
...
<table id="dataTable" border="1" style="width: 485px">
	...
	<tr><sf:form method="POST" action="">
		<td style="width: 200px"><label id="FromName1"></label></td>
		<td style="width: 150px"><label id="Accnum1"></label></td>
		<td><form action="" method="post">
		<button name="Button1" type="submit" value="View" style="width: 115px">View</button></form></td>
		</sf:form>
	</tr>
</table>
