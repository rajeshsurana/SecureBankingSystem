...
<body>
	...
	<div class="container">
		...
		<div class="panel panel-default">
			<div class="panel-heading">	List of New Account Holders that require Deletion approval</div>
				...
				<sf:form name="newBankUserApproval" id="newBankUserApproval" action=""
					...
					<c:choose>
						<c:when test="${empty bankuserList.bankUsers}">
							<H2>You do not have any Users to that have requested for Account Deletion</H2>
						</c:when>
						<c:otherwise>
