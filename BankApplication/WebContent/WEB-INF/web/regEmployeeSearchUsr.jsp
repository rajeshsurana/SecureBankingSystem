...
<script type="text/javascript">
	function check_field(id) {
		...
		if (isNaN(field.value)) {
			...
			document.searchUser.action = "UpdateUser.do";
			return true;
		}
	}
</script>
<meta http-equiv="Content-Type" content="text/html; charset=ISO-8859-1">
<title>Regular Employee - Search External User</title>
</head>
...
<body>
	...
	<div class="container">
		...
		<div class="panel panel-default">
			<div class="panel-heading">Search for User by Account Number</div>
			<div class="panel-body">
				<h2>Enter the Account Number to view the details for the
					user!!!</h2>
				<form name="searchUser" method="POST" action=""
					onsubmit="return check_field('bankAccountId');">
					<div class="form-group">
						<br /> <label for="Account Number" class="control-label">Enter
							the account Number</label> <input type="text" class="form-control"
