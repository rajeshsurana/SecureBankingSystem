...
<title>Merchant - Update Critical Information</title>
</head>
<body>
	...
	<div class="auto-style3" style="height: 332px">
		...
		<table class="auto-style4" style="width: 100%; height: 308px;">
			<tr>
				<td>Username</td>
				<td><c:out value="${merchant.userName}"></c:out></td>
				<td> <input name="UsernameField" style="width: 329px" type="text" /></td>
			</tr>
			<tr>
				<td>First Name</td>
				<td><c:out value="${merchant.FirstName}"></c:out></td>
				<td><input name="FnameField" style="width: 329px" type="text" /></td>
			</tr>
			<tr>
				<td>Last Name</td>
				<td><c:out value="${merchant.LastName}"></c:out></td>
				<td><input name="LnameField" style="width: 329px" type="text" /></td>
			</tr>
			<tr>
				<td>Merchant SSN</td>
				<td><c:out value="${merchant.SSN}"></c:out></td>
				<td><input name="SSNField" style="width: 329px" type="text" /></td>
			</tr>
		</table>
		<input name="Reset1" type="reset" value="Reset" class="auto-style10" style="width: 160px;" title="This will reset the entered fields" /> 
