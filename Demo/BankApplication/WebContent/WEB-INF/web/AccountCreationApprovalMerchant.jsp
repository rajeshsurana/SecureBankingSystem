...
<body>
	...
	<div class="container">
		...
		<div class="panel panel-default">
			<div class="panel-heading">	 List of New Merchant Account Holders that require approval	</div>
		...
		<c:choose>
			...
			<div class="table-responsive">
				...
				<input type="submit" class="control btn btn-primary"
					onclick="form.action='${pageContext.request.contextPath}/approveConfirmationForMerchant.do'"
					value="Approve" />
						&nbsp;
		<input type="submit" class="control btn btn-primary"
