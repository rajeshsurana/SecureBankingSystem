	...
	<div class="navbar navbar-default navbar-static-top">
		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<h3>Sorry, You do not have the authorization to view this information. Please contact the government to request for authorization</h3>
			</div>
